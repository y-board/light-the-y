...
2. Expand the `y-board-v4` folder to view the demos available for your board.
3. Note the different folders inside your board folder.  Each folder contains a separate demo application.
