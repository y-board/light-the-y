...
1. Enter the url `https://github.com/y-board/light-the-y-code.git` and hit Enter \
...
1. Type `git clone https://github.com/y-board/light-the-y-code.git` and press `Enter`
